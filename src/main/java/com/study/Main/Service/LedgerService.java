...
public interface LedgerService {
	...
	Page<Map<String, Object>> getAllLedgers(Long companyId, List<String> select, List<Character> groupTypes, int page,
			int size);
	...
	Map<String, Object> getLedgerById(Long ledgerId, List<String> select, Long companyId);
}
